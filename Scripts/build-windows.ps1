...
#
# Outputs:
#   resvg.artifactbundle/windows-x86_64/libresvg.lib
#   resvg.artifactbundle/windows-aarch64/libresvg.lib
...
Write-Host "  $BundleDir\windows-x86_64\libresvg.lib"
Write-Host "  $BundleDir\windows-aarch64\libresvg.lib"
