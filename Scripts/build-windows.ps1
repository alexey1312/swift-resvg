...
#
# Outputs:
#   resvg.artifactbundle/windows-x86_64/resvg.lib      (info.json path — Swift 6.3+ .lib handler)
#   resvg.artifactbundle/windows-x86_64/libresvg.lib   (compat copy for Swift 6.2 local builds)
#   resvg.artifactbundle/windows-aarch64/resvg.lib     (info.json path — Swift 6.3+ .lib handler)
#   resvg.artifactbundle/windows-aarch64/libresvg.lib  (compat copy for Swift 6.2 local builds)
...
Write-Host "  $BundleDir\windows-x86_64\resvg.lib (info.json path — Swift 6.3+)"
Write-Host "  $BundleDir\windows-x86_64\libresvg.lib (compat copy)"
Write-Host "  $BundleDir\windows-aarch64\resvg.lib (info.json path — Swift 6.3+)"
Write-Host "  $BundleDir\windows-aarch64\libresvg.lib (compat copy)"
